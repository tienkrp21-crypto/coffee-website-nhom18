    ...
    <div className="flex flex-col min-h-screen relative font-sans">
        ...
        <div className="container mx-auto flex justify-between items-center text-[10px] font-black uppercase tracking-[0.2em]">
          <div className="flex gap-6">
            <span className="flex items-center gap-2">
              <Mail size={14} /> nhom18@cafematerial.com
            </span>
            <span className="flex items-center gap-2">
              <Phone size={14} /> +09 999 999 999
            </span>
          </div>
      ...
      <header className="bg-dark sticky top-0 z-50 shadow-lg border-b-2 border-primary/30 h-24">
        <div className="container mx-auto px-4 h-full flex items-center justify-between">
          <Link
            to="/"
            className="text-3xl font-serif font-bold text-white uppercase tracking-widest flex items-center gap-2"
          >
          ...
          <nav className="hidden md:flex gap-10 items-center">
            <Link
              to="/"
              className={`font-black uppercase text-xs tracking-widest transition ${isActive("/") ? "text-primary" : "text-white hover:text-primary"}`}
            >
              Trang Chủ
            </Link>
            <Link
              to="/products"
              className={`font-black uppercase text-xs tracking-widest transition ${isActive("/products") || location.pathname.includes("/product/") ? "text-primary" : "text-white hover:text-primary"}`}
            >
              Menu Sản Phẩm
            </Link>
            <Link
              to="/about"
              className={`font-black uppercase text-xs tracking-widest transition ${isActive("/about") ? "text-primary" : "text-white hover:text-primary"}`}
            >
              Về Chúng Tôi
            </Link>
          </nav>
          ...
          <div className="flex items-center gap-8">
            ...
            <Link
              to="/cart"
              className="relative text-white hover:text-primary transition flex items-center gap-2 font-black uppercase text-xs tracking-widest"
            >
        ...
        {isLoginOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              animate={{ scale: 1, y: 0 }}
              exit={{ scale: 0.9, y: 20 }}
              className="bg-white w-full max-w-md relative shadow-2xl p-12 overflow-hidden"
            >
              <button
                onClick={() => setIsLoginOpen(false)}
              ...
              <div className="text-center mb-10">
                <h2 className="font-serif text-4xl text-dark mb-2 uppercase italic">
                  Đăng Nhập
                </h2>
        ...
        {isRegisterOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              animate={{ scale: 1, y: 0 }}
              exit={{ scale: 0.9, y: 20 }}
              className="bg-white w-full max-w-md relative shadow-2xl p-10 overflow-hidden"
            >
              <button
                onClick={() => setIsRegisterOpen(false)}
              ...
              <div className="text-center mb-8">
                <h2 className="font-serif text-3xl text-dark mb-1 uppercase tracking-tight">
                  Tạo Tài Khoản
                </h2>
                <p className="text-gray-400 text-xs italic">
                  Tham gia cùng CafeMaterial ngay hôm nay
                </p>
              ...
              <form onSubmit={handleRegister} className="space-y-4">
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-100 focus:border-primary outline-none bg-gray-50 font-serif text-sm"
                />
                <input
                  type="text"
                  required
                  ...
                  className="w-full px-4 py-3 border border-gray-100 focus:border-primary outline-none bg-gray-50 text-sm"
                />
                <input
                  type="email"
                  required
                ...
                <button
                  type="submit"
                  disabled={loadingReg}
                  className="w-full bg-primary text-white py-4 font-black uppercase text-xs tracking-[0.2em] hover:bg-dark transition-all mt-4 flex items-center justify-center"
                >
                  {loadingReg ? (
                    <Loader2 className="animate-spin" />
                  ) : (
      ...
      <footer
        ...
        style={{
          backgroundImage:
            'linear-gradient(rgba(43, 40, 37, .97), rgba(43, 40, 37, .97)), url("https://images.unsplash.com/photo-1497935586351-b67a49e012bf?q=80&w=1920")',
      ...
      >
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            <div>
              <h4 className="text-primary font-serif text-2xl uppercase mb-8 border-b border-gray-800 pb-4">
                Liên Hệ
              </h4>
              <ul className="space-y-4 text-gray-400 text-sm">
                ...
                <li className="flex items-center gap-3">
                  <Phone size={18} className="text-primary shrink-0" /> +012 345
                  6789
                </li>
                <li className="flex items-center gap-3">
                  <Mail size={18} className="text-primary shrink-0" />{" "}
                  info@cafematerial.com
                </li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400 text-sm">
                <li className="flex justify-between border-b border-gray-800 pb-2">
                  <span>Thứ 2 - Thứ 6:</span> <span>8:00 - 17:00</span>
                </li>
                <li className="flex justify-between border-b border-gray-800 pb-2">
                  <span>Thứ 7:</span> <span>8:00 - 12:00</span>
                </li>
                <li className="flex justify-between pb-2">
                  <span>Chủ Nhật:</span>{" "}
                  <span className="text-primary font-bold">Nghỉ</span>
                </li>
              </ul>
            </div>
            <div>
              ...
              <p className="text-gray-400 mb-6 text-sm">
                Đăng ký email để nhận ưu đãi mới nhất.
              </p>
              <div className="flex border-2 border-primary/30">
                ...
                />
                <button className="bg-primary px-4 py-2 text-dark font-black text-xs hover:bg-white transition">
                  GỬI
                </button>
              </div>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-500 text-[10px] font-black uppercase tracking-widest">
            <p>
              &copy; 2026 <span className="text-primary">CafeMaterial</span>.
              Crafted with Coffee.
            </p>
          </div>
        </div>
