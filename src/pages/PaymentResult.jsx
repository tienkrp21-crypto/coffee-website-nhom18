...
const PaymentResult = () => {
  ...
  return (
    <div className="font-sans text-gray-600 bg-white pb-20 min-h-screen">
      ...
      {/* ============================================
          2. NỘI DUNG THÔNG BÁO THÀNH CÔNG
      ============================================ */}
      <div className="container mx-auto px-4 max-w-3xl">
        <div className="bg-secondary border-inner p-10 md:p-16 text-center shadow-sm">
          ...
          <h2 className="text-4xl md:text-5xl font-heading text-dark uppercase mb-4">
            Đặt hàng thành công!
          </h2>
          <p className="text-lg text-gray-600 mb-2">
            Cảm ơn bạn đã tin tưởng và lựa chọn nguyên liệu tại CafeMaterial.
          </p>
          ...
          <div className="p-6 bg-white border border-gray-200 mb-10 inline-block text-left max-w-lg w-full shadow-inner">
            <h4 className="font-heading text-xl text-dark mb-3 border-b pb-2 uppercase">
              Thông tin giao hàng
            </h4>
            <ul className="text-sm text-gray-600 space-y-3">
              <li className="flex gap-2">
                <span className="text-primary font-bold">•</span>
                Hóa đơn chi tiết đã được gửi vào email của bạn.
              </li>
              <li className="flex gap-2">
                <span className="text-primary font-bold">•</span>
                Đơn hàng sẽ được đóng gói và giao đến bạn trong vòng 2-4 ngày
                làm việc.
              </li>
              <li className="flex gap-2">
                <span className="text-primary font-bold">•</span>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              to="/products"
              className="flex items-center justify-center gap-2 bg-primary text-dark font-heading px-8 py-4 uppercase text-lg hover:bg-white border-inner border-inner-dark transition"
            >
            ...
            <Link
              to="/"
              className="flex items-center justify-center gap-2 bg-dark text-white font-heading px-8 py-4 uppercase text-lg hover:bg-primary border-inner transition"
            >
